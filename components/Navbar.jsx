        ...
        <nav className={`py-4 lg:px-24 px-4 ${isSticky ? "sticky top-0 left-0 right-0 bg-blue-300" : ""}`}>
            <div className='flex justify-between items-center text-base gap-8'>
                ...
                <div className='flex items-center space-x-2'>
                    ...
                    <button className='bg-blue-700 px-10 py-2 text-white font-medium hover:bg-black transition-all ease-in duration-200'>
                        <Link to="/sign-up" className='block text-base uppercase cursor-pointer'>Sign Up</Link>
                    </button>
                </div>
            </div>
